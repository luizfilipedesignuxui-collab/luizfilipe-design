...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "hero.service_brand_title": "Identidade visual",
    "hero.service_brand": "Marca e visual consistentes em todos os pontos de contato",
    "hero.service_responsive_title": "UI responsiva",
    "hero.service_responsive": "Experiência fluida no celular, tablet e desktop",
    "hero.service_prototyping_title": "Prototipação",
    ...
    "about.text_3_default": "Se você é recrutador: entrego design com método, documentação clara e capacidade de trabalhar próximo ao time de produto e desenvolvimento. Se você busca um serviço: crio sites, apps, SaaS e redesigns com foco em usabilidade e conversão.",
    "about.text_4_default": "Neste portfólio estão cases reais, o processo que sigo e exemplos do que posso entregar para o seu time ou para o seu negócio.",
    ...
    "about.spec_de_desc": "Do design ao código: implemento experiências com React, Tailwind e Supabase.",
  ...
  en: {
    ...
    "hero.service_brand_title": "Visual identity",
    "hero.service_brand": "Consistent brand and visuals across every touchpoint",
    "hero.service_responsive_title": "Responsive UI",
    "hero.service_responsive": "A smooth experience on mobile, tablet, and desktop",
    "hero.service_prototyping_title": "Prototyping",
    ...
    "about.text_3_default": "If you're a recruiter: I bring structured design, clear documentation, and the ability to partner with product and engineering. If you're looking for a service: I build websites, apps, SaaS products, and redesigns focused on usability and conversion.",
    "about.text_4_default": "In this portfolio you'll find real case studies, the process I follow, and examples of what I can deliver for your team or your business.",
    ...
    "about.spec_de_desc": "From design to code: I ship experiences with React, Tailwind, and Supabase.",
