...
export interface Project {
 ...
 resultado: string;
 /** Matador metrics: problem → action → result with before/after visuals */
...
export const projects: Project[] = [
 ...
 descricao: "App de mobilidade urbana que une diferentes meios de transporte em uma só experiência: mais rápida, clara e sustentável para o dia a dia na cidade.",
 ...
 metricas: {
  narrativa: "Planejar um trajeto multimodal levava em média 8 minutos entre vários apps. Unifiquei busca, comparação e navegação em 3 passos e testei com usuários reais. Resultado: o tempo caiu para 25 segundos e 90% preferiram a rota sugerida.",
  narrativa_en: "Planning a multimodal trip took about 8 minutes across multiple apps. I unified search, comparison, and navigation into 3 steps and tested with real users. Result: time dropped to 25 seconds and 90% preferred the suggested route.",
  fluxo_antes: 6,
  fluxo_depois: 3,
  valor_antes: "8 min",
  valor_depois: "25 s",
  label: "planejamento",
  label_en: "planning time",
  validacao: "Testado com 20 usuários",
  validacao_en: "Tested with 20 users",
 },
 ...
 descricao_en: "Urban mobility app that brings different transport modes into one experience: faster, clearer, and more sustainable for everyday city commuting.",
 ...
 descricao: "E-commerce de velas artesanais com compra guiada: quiz personalizado, chatbot e visual minimalista para ajudar o cliente a escolher o aroma certo.",
 ...
 metricas: {
  narrativa: "Escolher uma vela sem orientação gerava abandono alto no catálogo. Criei um quiz guiado e reduzi a descoberta de 5 etapas soltas para 3 passos claros. Resultado: jornada mais curta e compra mais confiante.",
  narrativa_en: "Choosing a candle without guidance led to high catalog drop-off. I built a guided quiz and cut discovery from 5 scattered steps to 3 clear ones. Result: a shorter journey and more confident purchases.",
  fluxo_antes: 5,
  fluxo_depois: 3,
  valor_antes: "5 passos",
  valor_depois: "3 passos",
  label: "descoberta",
  label_en: "discovery",
  validacao: "Fluxo validado com pesquisa e protótipo",
  validacao_en: "Flow validated with research and prototype",
 },
 tags: ["E-commerce", "UX Design", "UI Design", "Branding"],
 link_projeto: "https://soulful-scents.lovable.app",
 titulo_en: "Aura Scent Boutique",
 descricao_en: "Handcrafted candle e-commerce with guided shopping: personalized quiz, chatbot, and minimalist visuals to help customers find the right scent.",
 categoria_en: "UX/UI Design",
 ...
 descricao: "App para grupos de amigos organizarem desafios fitness juntos: check-in diário, ranking, gamificação e cofrinho de metas.",
 ...
 metricas: {
  narrativa: "O desafio vivia espalhado no WhatsApp em várias mensagens e regras. Centralizei check-in, ranking e cofrinho em 4 fluxos claros. Resultado: grupo acompanha progresso em segundos, sem caçar informação no chat.",
  narrativa_en: "The challenge lived scattered across WhatsApp messages and rules. I centralized check-ins, rankings, and the shared pot into 4 clear flows. Result: the group tracks progress in seconds, without digging through chat.",
  fluxo_antes: 6,
  fluxo_depois: 4,
  valor_antes: "Chat",
  valor_depois: "1 app",
  ...
  validacao: "Baseado em dinâmica real com amigos",
  validacao_en: "Based on a real challenge with friends",
 },
 ...
 descricao_en: "App for groups of friends to run fitness challenges together: daily check-ins, rankings, gamification, and a shared goal pot.",
 categoria_en: "UX/UI Design",
 ...
 descricao: "App de bem-estar para estudantes: meditação guiada, relaxamento e rotinas de autocuidado para lidar com o estresse acadêmico.",
 ...
 metricas: {
  narrativa: "85% dos estudantes relataram ansiedade em períodos de prova sem ferramenta prática. Desenhei rotinas curtas em 3 fluxos (rotina, meditação, relaxamento) e testei com alunos reais. Resultado: 92% acharam fácil de usar e sessão média de 8 minutos em uma semana.",
  narrativa_en: "85% of students reported exam-period anxiety without a practical tool. I designed short routines in 3 flows (routine, meditation, relaxation) and tested with real students. Result: 92% found it easy to use, with an 8-minute average session in one week.",
  fluxo_antes: 5,
  fluxo_depois: 3,
  valor_antes: "85%",
  valor_depois: "92%",
  label: "ansiedade → facilidade",
  label_en: "anxiety → ease of use",
  validacao: "Testado com 15 estudantes",
  validacao_en: "Tested with 15 students",
 },
 ...
 descricao_en: "Wellness app for students: guided meditation, relaxation, and self-care routines to manage academic stress.",
 categoria_en: "UX/UI Design",
 ...
 descricao: "App colaborativo que mapeia locais acessíveis na cidade: com filtros, voz, rotas adaptadas e avaliações para pessoas com deficiência.",
 ...
 metricas: {
  narrativa: "90% das pessoas entrevistadas não confiavam em informações de acessibilidade online. Desenhei mapa, checklist e avaliação em 4 passos e priorizei voz e leitores de tela. Resultado: local acessível encontrado e verificado com mais confiança.",
  narrativa_en: "90% of interviewees did not trust online accessibility information. I designed map, checklist, and reviews in 4 steps and prioritized voice and screen readers. Result: accessible places found and verified with more confidence.",
  fluxo_antes: 6,
  fluxo_depois: 4,
  valor_antes: "90%",
  valor_depois: "Checklist",
  label: "desconfiança → verificação",
  label_en: "distrust → verification",
  validacao: "Pesquisa com 25 pessoas",
  validacao_en: "Research with 25 people",
 },
 ...
 descricao_en: "Collaborative app that maps accessible places in the city: with filters, voice, adapted routes, and reviews for people with disabilities.",
 categoria_en: "UX/UI Design",
 ...
 descricao: "Landing page para academia premium, do design à implementação com React e Supabase: pronta para captar leads e visitas.",
 ...
 metricas: {
  narrativa: "O briefing pedia presença digital premium sem atrito até o contato. Organizei a página de 7 blocos soltos para 4 seções de conversão e publiquei do Figma ao código. Resultado: landing no ar, responsiva e pronta para captar visitas.",
  narrativa_en: "The brief asked for a premium digital presence without friction to contact. I reshaped 7 loose blocks into 4 conversion sections and shipped from Figma to code. Result: a live, responsive landing ready to capture visits.",
  fluxo_antes: 7,
  fluxo_depois: 4,
  valor_antes: "Brief",
  valor_depois: "No ar",
  label: "entrega",
  label_en: "delivery",
  validacao: "Do Figma ao deploy em workshop",
  validacao_en: "From Figma to deploy in a workshop",
 },
 ...
 descricao_en: "Landing page for a premium gym, from design to React and Supabase implementation: ready to capture leads and visits.",
 categoria_en: "UX/UI Design",
 ...
 descricao: "Site institucional para psicanalista: do briefing ao ar. Design acolhedor, claro e focado em converter visitantes em sessões via WhatsApp.",
 ...
 metricas: {
  narrativa: "Visitantes hesitavam em marcar sessão online por falta de confiança e atrito. Reduzi a jornada de 6 etapas para 3 (hero, prova social, WhatsApp) e publiquei ponta a ponta. Resultado: site no ar com CTA direto para agendamento.",
  narrativa_en: "Visitors hesitated to book online sessions due to low trust and friction. I cut the journey from 6 steps to 3 (hero, social proof, WhatsApp) and shipped end to end. Result: a live site with a direct booking CTA.",
  fluxo_antes: 6,
  fluxo_depois: 3,
  valor_antes: "Dúvida",
  valor_depois: "WhatsApp",
  label: "conversão",
  label_en: "conversion",
  validacao: "Design Engineer: briefing ao deploy",
  validacao_en: "Design Engineer: brief to deploy",
 },
 ...
 descricao_en: "Institutional website for a psychoanalyst: from brief to live. Warm, clear design focused on converting visitors into WhatsApp bookings.",
 categoria_en: "UX/UI Design",
 ...
 id: "10",
 slug: "marmitagest",
 titulo: "MarmitaGest: SaaS Financeiro para Restaurantes",
 descricao: "SaaS financeiro para restaurantes: faturamento, custos, lucro e indicadores semanais em um só painel. Design e código ponta a ponta.",
 ...
 processo: {
 research: "Conversei com donos de restaurantes para entender como controlam o financeiro: como registram receitas, como acompanham custos fixos e variáveis e como calculam o lucro da semana. Identifiquei que o maior gargalo é a falta de visibilidade clara sobre o que realmente sobra no caixa.",
 wireframe: "Estruturei os fluxos principais: login → dashboard financeiro com KPIs → lançamento de receitas e custos → relatório semanal de desempenho. Priorizei poucas telas e ações de no máximo dois cliques para o dono operar com pressa no horário de pico.",
 ui_design: "Desenvolvi a identidade visual com laranja vibrante como cor principal, transmitindo apetite, energia e calor humano. Tipografia bold para os números, cards com hierarquia clara para os indicadores financeiros e gráficos limpos. Layout responsivo, do MacBook ao iPhone, com a mesma experiência fluida.",
 },
 resultado: "App pensado e construído inteiramente por mim, do descobrimento ao deploy. Plataforma no ar com dashboard financeiro, lançamento de receitas e custos, cálculo de lucro e painel semanal de desempenho. Projeto Design Engineer ponta a ponta: research, UI design, frontend, backend e publicação.",
 metricas: {
  narrativa: "O financeiro do restaurante vivia em caderno e planilhas dispersas. Uni faturamento, custos e lucro em 3 ações principais no painel. Resultado: dono vê a saúde da semana em um só lugar, do design ao código.",
  narrativa_en: "Restaurant finances lived in notebooks and scattered spreadsheets. I unified revenue, costs, and profit into 3 main dashboard actions. Result: owners see weekly health in one place, from design to code.",
  fluxo_antes: 6,
  fluxo_depois: 3,
  valor_antes: "Planilha",
  valor_depois: "1 painel",
  label: "controle",
  label_en: "control",
  validacao: "Conversas com donos de restaurante",
  validacao_en: "Talks with restaurant owners",
 },
 tags: ["Design Engineer", "SaaS", "Web App", "Mobile", "UI Design"],
 link_projeto: "https://marmitagest.vercel.app/",
 titulo_en: "MarmitaGest: Financial SaaS for Restaurants",
 descricao_en: "Financial SaaS for restaurants: revenue, costs, profit, and weekly indicators in one dashboard. End-to-end design and code.",
 categoria_en: "UX/UI Design",
 contexto_en: "Small restaurants still track finances on paper or scattered spreadsheets. This manual process leads to calculation errors, lost revenue and makes it hard to clearly see how much is actually left at the end of the week.\n\nMarmitaGest was created to solve this pain: give the restaurant owner a simple, fast and visual tool to monitor the financial health of the business in one place.",
 objetivo_en: "Build a web and mobile SaaS dedicated to financial management for restaurants: revenue tracking, costs and expenses, automatic profit calculation and a dashboard with weekly indicators. The goal is an accessible, intuitive and visually warm tool, even for users with low tech familiarity.",
 resultado_en: "App thought through and built entirely by me, from discovery to deploy. Live platform with a financial dashboard, revenue and cost entries, profit calculation and a weekly performance panel. End-to-end Design Engineer project: research, UI design, frontend, backend and publishing.",
 processo_en: {
 research: "I talked to restaurant owners to understand how they handle their finances: how they record revenue, track fixed and variable costs and calculate weekly profit. I found that the biggest bottleneck is the lack of clear visibility on what is actually left in the cash flow.",
 wireframe: "I structured the main flows: login → financial dashboard with KPIs → revenue and cost entries → weekly performance report. I prioritized few screens and max-two-click actions so the owner can operate quickly during rush hour.",
 ui_design: "I developed the visual identity with vibrant orange as the main color, conveying appetite, energy and human warmth. Bold typography for numbers, cards with clear hierarchy for financial indicators and clean charts. Responsive layout from MacBook to iPhone with the same fluid experience.",
 },
 ...
 descricao: "Loja online de moda fitness feminina: catálogo elegante, favoritos e venda direta pelo WhatsApp. Design e desenvolvimento ponta a ponta.",
 ...
 metricas: {
  narrativa: "Checkout tradicional criava atrito em uma loja que vende pelo WhatsApp. Cortei o fluxo de 5 etapas de carrinho para 2 (produto → Tenho interesse). Resultado: contato direto com a loja em um clique, site no ar.",
  narrativa_en: "Traditional checkout created friction for a store that sells via WhatsApp. I cut the cart flow from 5 steps to 2 (product → I'm interested). Result: direct store contact in one click, live site.",
  fluxo_antes: 5,
  fluxo_depois: 2,
  valor_antes: "5 passos",
  valor_depois: "1 clique",
  label: "compra",
  label_en: "purchase",
  validacao: "Design Engineer ponta a ponta",
  validacao_en: "End-to-end Design Engineer",
 },
 ...
 descricao_en: "Women's fitness fashion store: elegant catalog, favorites, and direct sales via WhatsApp. End-to-end design and development.",
 categoria_en: "UX/UI Design",
